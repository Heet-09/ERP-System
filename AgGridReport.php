...
let h;
  ...
  // window.sortState = gridApi.getSortModel();
  // console.log(window.sortState);
    ...
    init(params) {
      ...
      const gridOptions = {
        ...
        columnDefs: [
          ...
          {field: "mission",flex:2,valueFormatter: (params) => {return "" + params.value.toLocaleString();},checkboxSelection: true,},
          {field: "company",flex:1,cellRenderer: CompanyLogoRenderer,},
          {field: "location" },
          {field: "date" },
          {field: "price"},
          {field: "successful" },
