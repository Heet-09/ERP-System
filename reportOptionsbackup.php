  ...
  <div class="panel-body">
    ...
    <div class="pivotgrid-display">
      <div class="dx-viewport demo-container">
        ...
        <!-- </div>X` -->
    <script>
      var heet= <?php echo json_encode($viewResult['result_set']); ?>;
      // console.log(heet);
      // console.log("in big script");
console.log("modal from loadDtaa");

var kreon = 0;
var globalstate;
console.log(globalstate);
console.log("TyprID"+typeId);
function save() {
  console.log('save');
  //  kreon = 1;
                ...
                // console.log(kreon);
                  ...
                  const salesPivotGrid = $("#sales").dxPivotGrid({
                    ...
                    stateStoring: {
                      ...
                      //       return (kreon === 1) ? sendStorageRequest("organisatieKey", "text", "PUT", gridState) : console.log("jjj");;
                      //   },     
                      customSave: function(gridState) {
                        console.log(kreon, "in customsave");
                          ...
                          if (kreon === 1) {
                            console.log("executig custom save from the state storing function");
                              ...
                              console.log("jjj");
                              return null; // or whatever value you want to return if kreon is not 1
                            }
