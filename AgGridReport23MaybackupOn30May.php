    ...
    $('.templateSelect').change(function () {
      ...
      getDataFromAPI(1, templateId, tempName, templateDescription, typeId, (error, data) => {
        ...
        if (error) {
          ...
          gridApi.applyColumnState({ state: data});
          console.log('After Fetched', gridApi.getColumnState());
...
<script>
  ...
  //   // fetch("http://localhost/kreonprimary2/AgGridReportDataStorage.php?ReportID=1&templateId=363&tempName=mark47&templateDescription=&typeID=1")
