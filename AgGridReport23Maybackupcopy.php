  ...
  $(document).ready(function () {
    ...
    $('.templateSelect').change(function () {
      ...
      tempName=$('#templateSelect').find('option:selected').text();
            ...
            console.log("in upper template  q api");
            if (error) {
              ...
              console.log("After Fetche",gridApi.getColumnState());
            }
          });
            ...
            <!-- <form id="modalForm" name="modal" role="form">  -->
              ...
              <script>
                function modalvalue(){
                    ...
                    sendStorageRequest("storageKey", "text", "PUT", gridApi.getColumnState());
                }
              </script>
            <!-- </form> -->
          </div>   
  ...
  const columnDefs = [
    ...
    const gridOptions = {
      ...
      onStateUpdated:event =>{
        ...
        // // alert("l");
        console.log(gridApi.getFilterState());
        
        topg++
        console.log(topg);
        templateg++;
        console.log(templateg);
        if(topg==3)
        gridApi.applyColumnState({ 
            state: pivotglobalsource,
            applyOrder: true,
          });
        // saveState();
        },
