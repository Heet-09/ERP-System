  ...
  $(document).ready(function () {
    ...
    $('.typeSelect').change(function () {
      ...
      if (selectedType === "1") {
        ...
        $('.pivotgrid-div').html('<div>   <div id="myGrid" style="" class="ag-theme-balham"></div></div>');
    ...
    $('.templateSelect').change(function () {
      if (selectedType === "1") {
        $('.pivotgrid-div').html('<div id="myGrid" style="" class="ag-theme-balham"></div>');
        $('.pivotgrid-display').show(); // Show pivotgrid-display if Pivot Grid is selected
        $('.datagrid-display').hide(); // Hide datagrid-display
        $('.datagrid-div').html('');
        loadPivotGridData();
